...
from ...models.v0043_openapi_assocs_removed_resp import V0043OpenapiAssocsRemovedResp
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = V0043OpenapiAssocsRemovedResp.from_dict(response.json())

        return response_200

    response_default = V0043OpenapiAssocsRemovedResp.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[V0043OpenapiAssocsRemovedResp]:
    return Response(
...
def sync(
    *,
    ...
    usage_start: Union[Unset, str] = UNSET,
    user: Union[Unset, str] = UNSET,
) -> Optional[V0043OpenapiAssocsRemovedResp]:
    """Delete association
