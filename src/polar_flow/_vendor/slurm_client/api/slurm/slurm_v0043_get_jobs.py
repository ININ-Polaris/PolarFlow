...
from ...models.slurm_v0043_get_jobs_flags import SlurmV0043GetJobsFlags
...
def _get_kwargs(
    *,
    ...
    flags: Union[Unset, SlurmV0043GetJobsFlags] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (Union[Unset, SlurmV0043GetJobsFlags]):
