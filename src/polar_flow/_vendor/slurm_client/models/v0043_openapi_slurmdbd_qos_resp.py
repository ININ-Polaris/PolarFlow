...
T = TypeVar("T", bound="V0043OpenapiSlurmdbdQosResp")


@_attrs_define
class V0043OpenapiSlurmdbdQosResp:
    """
    Attributes:
        qos (list['V0043Qos']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_slurmdbd_qos_resp = cls(
            qos=qos,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_slurmdbd_qos_resp.additional_properties = d
        return v0043_openapi_slurmdbd_qos_resp
