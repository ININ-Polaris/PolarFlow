...
T = TypeVar("T", bound="V0043OpenapiKillJobsResp")
...
class V0043OpenapiKillJobsResp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_kill_jobs_resp = cls(
            status=status,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_kill_jobs_resp.additional_properties = d
        return v0043_openapi_kill_jobs_resp
