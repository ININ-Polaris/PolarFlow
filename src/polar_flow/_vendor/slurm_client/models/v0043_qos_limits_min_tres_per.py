...
T = TypeVar("T", bound="V0043QosLimitsMinTresPer")


@_attrs_define
class V0043QosLimitsMinTresPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_qos_limits_min_tres_per = cls(
            job=job,
        )

        v0043_qos_limits_min_tres_per.additional_properties = d
        return v0043_qos_limits_min_tres_per
