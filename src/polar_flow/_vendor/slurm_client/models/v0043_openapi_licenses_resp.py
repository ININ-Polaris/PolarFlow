...
if TYPE_CHECKING:
    from ..models.v0043_license import V0043License
...
T = TypeVar("T", bound="V0043OpenapiLicensesResp")
...
class V0043OpenapiLicensesResp:
    ...
    def to_dict(self) -> dict[str, Any]:
        licenses = []
        for componentsschemasv0_0_43_licenses_item_data in self.licenses:
            componentsschemasv0_0_43_licenses_item = componentsschemasv0_0_43_licenses_item_data.to_dict()
            licenses.append(componentsschemasv0_0_43_licenses_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_43_licenses_item_data in _licenses:
            componentsschemasv0_0_43_licenses_item = V0043License.from_dict(componentsschemasv0_0_43_licenses_item_data)
        ...
        v0043_openapi_licenses_resp = cls(
            licenses=licenses,
            last_update=last_update,
            meta=meta,
            errors=errors,
        ...
        v0043_openapi_licenses_resp.additional_properties = d
        return v0043_openapi_licenses_resp
