...
if TYPE_CHECKING:
    ...
    from ..models.v0043_stats_msg import V0043StatsMsg


T = TypeVar("T", bound="V0043OpenapiDiagResp")


@_attrs_define
class V0043OpenapiDiagResp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        statistics = V0043StatsMsg.from_dict(d.pop("statistics"))
        ...
        v0043_openapi_diag_resp.additional_properties = d
        return v0043_openapi_diag_resp
