...
class V0043RollupStatsDaily:
    """
    Attributes:
        count (Union[Unset, int]): Number of daily rollups since last_run
        last_run (Union[Unset, int]): Last time daily rollup ran (UNIX timestamp) (UNIX timestamp or time string
