...
T = TypeVar("T", bound="V0043OpenapiClustersResp")


@_attrs_define
class V0043OpenapiClustersResp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_clusters_resp = cls(
            clusters=clusters,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_clusters_resp.additional_properties = d
        return v0043_openapi_clusters_resp
