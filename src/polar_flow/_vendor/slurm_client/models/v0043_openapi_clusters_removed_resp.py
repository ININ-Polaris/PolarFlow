...
T = TypeVar("T", bound="V0043OpenapiClustersRemovedResp")
...
class V0043OpenapiClustersRemovedResp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_clusters_removed_resp = cls(
            deleted_clusters=deleted_clusters,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_clusters_removed_resp.additional_properties = d
        return v0043_openapi_clusters_removed_resp
