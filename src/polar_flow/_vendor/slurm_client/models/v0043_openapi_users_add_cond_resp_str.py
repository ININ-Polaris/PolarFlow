...
T = TypeVar("T", bound="V0043OpenapiUsersAddCondRespStr")
...
class V0043OpenapiUsersAddCondRespStr:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_users_add_cond_resp_str = cls(
            added_users=added_users,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_users_add_cond_resp_str.additional_properties = d
        return v0043_openapi_users_add_cond_resp_str
