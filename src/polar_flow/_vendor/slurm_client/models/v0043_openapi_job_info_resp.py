...
if TYPE_CHECKING:
    from ..models.v0043_job_info import V0043JobInfo
...
T = TypeVar("T", bound="V0043OpenapiJobInfoResp")
...
class V0043OpenapiJobInfoResp:
    ...
    def to_dict(self) -> dict[str, Any]:
        jobs = []
        for componentsschemasv0_0_43_job_info_msg_item_data in self.jobs:
            componentsschemasv0_0_43_job_info_msg_item = componentsschemasv0_0_43_job_info_msg_item_data.to_dict()
            jobs.append(componentsschemasv0_0_43_job_info_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs = []
        _jobs = d.pop("jobs")
        for componentsschemasv0_0_43_job_info_msg_item_data in _jobs:
            componentsschemasv0_0_43_job_info_msg_item = V0043JobInfo.from_dict(
                componentsschemasv0_0_43_job_info_msg_item_data
            )

            jobs.append(componentsschemasv0_0_43_job_info_msg_item)

        last_backfill = V0043Uint64NoValStruct.from_dict(d.pop("last_backfill"))
        ...
        v0043_openapi_job_info_resp = cls(
            jobs=jobs,
            last_backfill=last_backfill,
            last_update=last_update,
            meta=meta,
        ...
        v0043_openapi_job_info_resp.additional_properties = d
        return v0043_openapi_job_info_resp
