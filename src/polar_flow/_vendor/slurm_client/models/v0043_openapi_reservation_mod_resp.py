...
T = TypeVar("T", bound="V0043OpenapiReservationModResp")


@_attrs_define
class V0043OpenapiReservationModResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_43_reservation_desc_msg_list_item_data in _reservations:
        ...
        v0043_openapi_reservation_mod_resp = cls(
            reservations=reservations,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_reservation_mod_resp.additional_properties = d
        return v0043_openapi_reservation_mod_resp
