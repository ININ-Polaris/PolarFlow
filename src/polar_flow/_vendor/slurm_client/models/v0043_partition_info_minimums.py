...
T = TypeVar("T", bound="V0043PartitionInfoMinimums")
...
class V0043PartitionInfoMinimums:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_partition_info_minimums = cls(
            nodes=nodes,
        )

        v0043_partition_info_minimums.additional_properties = d
        return v0043_partition_info_minimums
