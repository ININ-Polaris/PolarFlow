...
T = TypeVar("T", bound="V0043Uint64NoValStruct")
...
class V0043Uint64NoValStruct:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_uint_64_no_val_struct = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0043_uint_64_no_val_struct.additional_properties = d
        return v0043_uint_64_no_val_struct
