...
T = TypeVar("T", bound="V0043OpenapiInstancesResp")


@_attrs_define
class V0043OpenapiInstancesResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_instances_resp = cls(
            instances=instances,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_instances_resp.additional_properties = d
        return v0043_openapi_instances_resp
