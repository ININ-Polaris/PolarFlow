...
if TYPE_CHECKING:
    ...
    from ..models.v0043_partition_info import V0043PartitionInfo
    from ..models.v0043_uint_64_no_val_struct import V0043Uint64NoValStruct


T = TypeVar("T", bound="V0043OpenapiPartitionResp")
...
class V0043OpenapiPartitionResp:
    ...
    def to_dict(self) -> dict[str, Any]:
        partitions = []
        for componentsschemasv0_0_43_partition_info_msg_item_data in self.partitions:
            componentsschemasv0_0_43_partition_info_msg_item = (
                componentsschemasv0_0_43_partition_info_msg_item_data.to_dict()
            )
            partitions.append(componentsschemasv0_0_43_partition_info_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_43_partition_info_msg_item_data in _partitions:
            componentsschemasv0_0_43_partition_info_msg_item = V0043PartitionInfo.from_dict(
                componentsschemasv0_0_43_partition_info_msg_item_data
            )
        ...
        v0043_openapi_partition_resp = cls(
            partitions=partitions,
            last_update=last_update,
            meta=meta,
            errors=errors,
        ...
        v0043_openapi_partition_resp.additional_properties = d
        return v0043_openapi_partition_resp
