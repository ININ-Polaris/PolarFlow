...
T = TypeVar("T", bound="V0043OpenapiSlurmdbdQosRemovedResp")


@_attrs_define
class V0043OpenapiSlurmdbdQosRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        removed_qos = cast(list[str], d.pop("removed_qos"))
        ...
        v0043_openapi_slurmdbd_qos_removed_resp = cls(
            removed_qos=removed_qos,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_slurmdbd_qos_removed_resp.additional_properties = d
        return v0043_openapi_slurmdbd_qos_removed_resp
