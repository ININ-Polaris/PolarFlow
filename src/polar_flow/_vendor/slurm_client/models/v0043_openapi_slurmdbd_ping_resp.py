...
if TYPE_CHECKING:
    ...
    from ..models.v0043_slurmdbd_ping import V0043SlurmdbdPing


T = TypeVar("T", bound="V0043OpenapiSlurmdbdPingResp")


@_attrs_define
class V0043OpenapiSlurmdbdPingResp:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        pings = []
        for componentsschemasv0_0_43_slurmdbd_ping_array_item_data in self.pings:
            componentsschemasv0_0_43_slurmdbd_ping_array_item = (
                componentsschemasv0_0_43_slurmdbd_ping_array_item_data.to_dict()
            )
            pings.append(componentsschemasv0_0_43_slurmdbd_ping_array_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pings = []
        _pings = d.pop("pings")
        for componentsschemasv0_0_43_slurmdbd_ping_array_item_data in _pings:
            componentsschemasv0_0_43_slurmdbd_ping_array_item = V0043SlurmdbdPing.from_dict(
                componentsschemasv0_0_43_slurmdbd_ping_array_item_data
            )
        ...
        v0043_openapi_slurmdbd_ping_resp = cls(
            pings=pings,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_slurmdbd_ping_resp.additional_properties = d
        return v0043_openapi_slurmdbd_ping_resp
