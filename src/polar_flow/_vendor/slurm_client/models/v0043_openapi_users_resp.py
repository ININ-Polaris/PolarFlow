...
T = TypeVar("T", bound="V0043OpenapiUsersResp")


@_attrs_define
class V0043OpenapiUsersResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_users_resp.additional_properties = d
        return v0043_openapi_users_resp
