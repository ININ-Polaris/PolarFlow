...
T = TypeVar("T", bound="V0043AssocMaxTresMinutesPer")


@_attrs_define
class V0043AssocMaxTresMinutesPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_assoc_max_tres_minutes_per = cls(
            job=job,
        )

        v0043_assoc_max_tres_minutes_per.additional_properties = d
