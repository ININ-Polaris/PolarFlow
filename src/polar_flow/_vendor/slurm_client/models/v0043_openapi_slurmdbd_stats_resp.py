...
if TYPE_CHECKING:
    ...
    from ..models.v0043_stats_rec import V0043StatsRec


T = TypeVar("T", bound="V0043OpenapiSlurmdbdStatsResp")


@_attrs_define
class V0043OpenapiSlurmdbdStatsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        statistics = V0043StatsRec.from_dict(d.pop("statistics"))
        ...
        v0043_openapi_slurmdbd_stats_resp = cls(
            statistics=statistics,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_slurmdbd_stats_resp.additional_properties = d
        return v0043_openapi_slurmdbd_stats_resp
