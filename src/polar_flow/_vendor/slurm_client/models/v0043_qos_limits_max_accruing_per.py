...
T = TypeVar("T", bound="V0043QosLimitsMaxAccruingPer")


@_attrs_define
class V0043QosLimitsMaxAccruingPer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_qos_limits_max_accruing_per = cls(
            account=account,
            user=user,
        )

        v0043_qos_limits_max_accruing_per.additional_properties = d
        return v0043_qos_limits_max_accruing_per
