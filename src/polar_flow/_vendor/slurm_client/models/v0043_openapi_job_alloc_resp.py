...
T = TypeVar("T", bound="V0043OpenapiJobAllocResp")


@_attrs_define
class V0043OpenapiJobAllocResp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_job_alloc_resp = cls(
            job_id=job_id,
        ...
        v0043_openapi_job_alloc_resp.additional_properties = d
        return v0043_openapi_job_alloc_resp
