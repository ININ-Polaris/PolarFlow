...
T = TypeVar("T", bound="V0043OpenapiAccountsAddCondRespStr")


@_attrs_define
class V0043OpenapiAccountsAddCondRespStr:
    added_accounts: str
    """ added_accounts """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_accounts_add_cond_resp_str = cls(
            added_accounts=added_accounts,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_accounts_add_cond_resp_str.additional_properties = d
        return v0043_openapi_accounts_add_cond_resp_str
