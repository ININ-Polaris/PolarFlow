...
T = TypeVar("T", bound="V0043OpenapiWckeyRemovedResp")


@_attrs_define
class V0043OpenapiWckeyRemovedResp:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_openapi_wckey_removed_resp = cls(
            deleted_wckeys=deleted_wckeys,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0043_openapi_wckey_removed_resp.additional_properties = d
        return v0043_openapi_wckey_removed_resp
