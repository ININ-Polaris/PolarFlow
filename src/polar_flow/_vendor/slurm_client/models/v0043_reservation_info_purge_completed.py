...
T = TypeVar("T", bound="V0043ReservationInfoPurgeCompleted")
...
class V0043ReservationInfoPurgeCompleted:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0043_reservation_info_purge_completed = cls(
            time=time,
        )

        v0043_reservation_info_purge_completed.additional_properties = d
        return v0043_reservation_info_purge_completed
